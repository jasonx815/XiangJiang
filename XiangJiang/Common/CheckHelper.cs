    ...
    public static class CheckHelper
    {
        ...
        public static bool IsIp46Address(string data)
        {
            ...
            if (!string.IsNullOrEmpty(data))
            {
                ...
                {
                    if (Uri.TryCreate(string.Format("http://{0}", data), UriKind.Absolute, out _)) result = true;
                }
        ...
        {
            return RegexHelper.IsMatch(data, RegexPattern.MacAddr6Check) ||
                   RegexHelper.IsMatch(data, RegexPattern.MacAddr7Check);
        }
